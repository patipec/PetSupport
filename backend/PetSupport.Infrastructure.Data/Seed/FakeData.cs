...
namespace PetSupport.Infrastructure.Data.Seed
{
    public class FakeData
    {
        ...
        public FakeData()
        {
            ...
            //     .RuleFor(p => p.PetsitterId, f => FakePetsitters.)
            //     .RuleFor(p => p.ServiceId, f => FakePetsitters.)
            ...
            var petsitterFaker = new Faker<Petsitter>()
                ...
                //TODO: Verify entities PetSitterService. Correct this.
                //.RuleFor(p => p.Services, f =>f.PickRandom(FakeServices));
            ...
            var bookingMessageFaker = new Faker<BookingMessage>()
                ...
                .RuleFor(bm => bm.PetsitterId, f => f.Random.ListItem(FakePetsitters).Id)
                .RuleFor(bm => bm.ClientId, f => f.Random.ListItem(FakeClients).Id)
